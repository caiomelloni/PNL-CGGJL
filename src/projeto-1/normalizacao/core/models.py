"""Modelos e validações das tabelas de nós e arestas."""
...
def _serialize_attribute_value(value: Any) -> str:
...
def serialize_attributes(attributes: dict[str, Any]) -> str:
    """Serializa somente atributos preenchidos."""
    parts = []
    ...
    for key, value in attributes.items():
        ...
        parts.append(
            f"{key}={_serialize_attribute_value(value)}"
        )
