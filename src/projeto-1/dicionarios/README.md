...
- Falta fechar os entregáveis finais (rodar em lote e persistir as tabelas, escrever `docs/projeto-1/06-dicionarios.md`). O processo 8 (gazetteer próprio de `AnatomicalSite`) segue adiado por decisão do autor.
